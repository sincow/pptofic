...
class imprimirDocumento {
	...
	public function traerImpresionDocumento() {
      ...
      if ($this->informe == null) {
			...
			$pdf->SetFont('Arial', '', 8);
         $pdf->Output('I', "EC-".$this->id_movimiento.'.pdf', true);
         return;
      }
      $valDocum = $this->informe['valor_entrada'];
      // if ($this->tipoDoc == '2') {
      //    $valDocum = $this->informe['valor_entrada'];
      // }
      ...
      $pdf->Ln(0);
      $pdf->Cell(120);
		$pdf->Cell(70, 5, "", 1, 0, 'L', false);
      $pdf->Ln(0);
      $pdf->Cell(102);
		$pdf->SetTextColor(255, 255, 255);
		$pdf->SetFont('Arial', 'B', 10);
      $pdf->Cell(65, 5, 'ENTRADA DE EFECTIVO A CAJA Nro', 0, 0, 'L', true);
		$pdf->SetTextColor(0, 0, 0);
      $pdf->Ln(0);
      $pdf->Cell(165);
      ...
      $pdf->Ln(0);
		$pdf->SetTextColor(255, 255, 255);
      $pdf->Cell(125, 5, 'RECIBIDO DE:', 0, 0, 'L', true);
      $pdf->Cell(5);
      ...
      $pdf->Cell(15);
      $pdf->Cell(30, 0,"$ ". number_format($valDocum, 2), 0, 0, 'R', false);
      $pdf->Ln(4);
      ...
      $pdf->Ln(6);
		$pdf->SetTextColor(0, 0, 0);
		$valletras = convertir($valDocum, '1');
      ...
      $pdf->Cell(30);
      $pdf->Cell(80, 0, 'Entregó: ', 0, 0, 'L', false);
      $pdf->Ln(5);
      $pdf->Cell(80, 0, $this->informe['name'], 0, 0, 'L', false);
      $pdf->Cell(30);
      $pdf->Cell(80, 0, 'Doc Identidad: ', 0, 0, 'L', false);

      $pdf->Output('I', "EC-".$this->informe['consecutivo'].'.pdf', true);
   }
