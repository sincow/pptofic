	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title fw-bolder" id="modalUserAddTit">Crear Usuario</h4>
            ...
            <input type="hidden" id="action" name="action" value="create">
               ...
               <div class="card mb-0">
                  <div class="card-body p-4">
                     <div class="row">
                        <div class="col-md-3">
                           <label for="newPhoto" class="text-label ps-3" >Seleccione Foto</label>
                           <div class="d-flex align-items-end position-relative mb-5">
                              <input class="d-none photoUser" type="file" id="newPhoto" name="photo" accept="image/png, image/jpg, image/webp" />
                              <div class="hoverbox" style="width: 150px; height: 150px">
                                 ...
                                 <div class="position-relative bg-400 rounded-circle cursor-pointer d-flex flex-center mb-xxl-7">
                                    <div class="avatar avatar-5xl"><img class="rounded-circle photoUserFile" src="assets/img/team/avatar.webp" alt="" /></div>
                                    <label class="cursor-pointer w-100 h-100 position-absolute z-index-1" for="newPhoto"></label>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row col-md-9 pe-0">
                           <div class="col-md-12 mb-3 pe-0">
                              <label for="newname" class="text-label fs-0 ps-1">Nombre</label>
                              <input type="text" class="form-control" id="newname" name="nombre">
                           </div>
                           <div class="col-md-12 mb-3 pe-0">
                              <label for="newemail" class="text-label fs-0 ps-1">Correo Electrónico</label>
                     ...
                     <div class="row g-3">
                        ...
                        <div class="col-md-3">
                           <label for="newpassword" class="text-label fs-0 ps-1">Contraseña</label>
            ...
            <div class="modal-footer">
               <button type="submit" class="btn btn-phoenix-primary" id="btnUserAdd">Agregar</button>
