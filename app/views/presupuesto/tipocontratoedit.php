	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title fw-bolder" id="modalTipoContratoEdit">Editar Tipo de Contrato</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form role="form" id="formTipoContratoEdit" method="post">
            ...
            <div class="modal-footer">
               <button type="submit" class="btn btn-phoenix-primary" id="btnTipoContratoEdit">Guardar</button>
