<div id="modalOrigIngresoAdd" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title fw-bolder" id="modalOrigIngresoAddTit">Adicionar Origen Específico de Ingreso</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form class="needs-validation" role="form" id="formOrigIngresoAdd" method="post" novalidate>
            ...
            <div class="modal-footer">
               <button type="submit" class="btn btn-phoenix-primary" id="btnOrigIngresoAdd">Guardar</button>
