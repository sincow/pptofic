<div id="modalChipEdit" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title fw-bolder" id="modalChipEdit">Editar Codigo Chip</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form role="form" id="formChipEdit" method="post">
            ...
            <div class="modal-footer">
               <button type="submit" class="btn btn-phoenix-primary" id="btnChipEdit">Guardar</button>
