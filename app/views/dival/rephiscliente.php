<div class="content p-2 pt-10">
   <div class="row mb-3">
      <div class="col-lg-8">
         <h4 class="mb-0">Histórico de Clientes</h4>
      </div>
      <div class="col-lg-4 pt-1">
         <nav class="mb-0" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 float-sm-end">
               ...
               <li class="breadcrumb-item active">>Histórico Clientes</li>
            </ol>
         </nav>
      </div>
   </div>
   ...
   <form class="needs-validation frmReports" role="form" id="frmReports" method="post" action="" novalidate>
      ...
      <input type="hidden" id="action" name="action" value="rephiscliente">
      <div class="row g-3">
                                 ...
                                 <div class="col-md-7 col-xl-4 mt-0 mb-0">
                                    ...
                                    <div class="form-control mb-0 p-0 border-0">
                                       <select class="form-control select2" style="width: 100%;" name="repIdCliente" id="repIdCliente" required>
                                          <option value="" codeSeller="">Seleccione Cliente</option>
                                       </select>
                                    </div>
                                 </div>
                              </div>
                              <div class="row g-3 mt-1 mb-0">
                                 <label class="text-label fs-0 ps-2" for="repFecIniHisCli">Fecha Inicial</label>
                                 <div class="col-md-3 col-xl-1 mt-0 mb-3">
                                    <div class="form-control mb-0 p-0 border-0">
                                       <input type="text" class="form-control datepicker py-2 dp_fecha_ini" id="repFecIniHisCli" name="repFecIniHisCli" placeholder="<?php echo DATE_DISPLAY ?>" data-inputmask="'alias': '<?= DATE_DISPLAY ?>'" autocomplete="off" data-mask value="<?php echo date('Y-m-d', strtotime('-2 years')); ?>" required>
                                    </div>
                                 </div>
                              </div>
                              <div class="row g-3 mt-1 mb-0">
                                 <label class="text-label fs-0 ps-2" for="repFecFinHisCli">Fecha Final</label>
                                 <div class="col-md-3 col-xl-1 mt-0 mb-3">
                                    <div class="form-control mb-0 p-0 border-0">
                                       <input type="text" class="form-control datepicker py-2 dp_fecha_fin" id="repFecFinHisCli" name="repFecFinHisCli" placeholder="<?php echo DATE_DISPLAY ?>" data-inputmask="'alias': '<?= DATE_DISPLAY ?>'" autocomplete="off" data-mask value="<?php echo date('Y-m-d'); ?>" required>
                                    </div>
                                 </div>
                              </div>
