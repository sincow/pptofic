<div class="content p-2 pt-10">
   <div class="row mb-3">
      <div class="col-lg-8">
         <h4 class="mb-0">Reimpresión Asignación Tarea</h4>
      </div>
      <div class="col-lg-4 pt-1">
         <nav class="mb-0" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 float-sm-end">
               ...
               <li class="breadcrumb-item active">>Reimpresión Tarea</li>
            </ol>
         </nav>
      </div>
   </div>
   ...
   <form class="needs-validation frmReports" role="form" id="frmReports" method="post" action="" novalidate>
      ...
      <input type="hidden" id="action" name="action" value="reptarea">
                        ...
                        <div class="row align-items-center g-5 text-center text-sm-start">
                           <div class="col-12 col-sm-auto flex-1 mt-0 mb-2">
                              <div class="row g-3 mt-3">
                                 <label class="text-label fs-0 ps-2" for="repNroDomum">Número Tarea</label>
