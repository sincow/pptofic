<div class="content p-2 pt-10">
	<div class="row mb-4">
   	<div class="col-lg-8">
      	<h4 class="mb-0">Entrada de efectivo a Caja</h4>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-2 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Entrada efectivo</li>
      		</ol>
      	</nav>
   	</div>
	</div>
                  ...
                  <div class="row g-3">
                     ...
                     <div class="col-sm-6 col-lg-4 mb-3">
                        <div class="form-group text-end">
                           <label for="entrValor" class="text-label fs-0 ps-0">Valor Entrada *</label>
                  ...
                  <div class="row g-3">
                     <div class="col-12 mb-3">
                        <div class="d-grid gap-2">
                           <button class="btn btn-phoenix-success" type="submit" id="btnEntradaCajaAdd">GRABAR ENTRADA</button>
                        </div>
                     </div>
                  </div>
               </div>
