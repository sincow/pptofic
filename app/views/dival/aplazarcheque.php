...
<div class="content p-2 pt-10">
	<div class="row mb-4">
   	<div class="col-lg-8">
      	<h4 class="mb-0">Aplazamiento de Cheque</h4>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-2 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Aplazamiento Cheque</li>
      		</ol>
      	</nav>
   	</div>
	</div>
	<form class="needs-validation form-search aplazachequeForm" role="form" id="aplazachequeForm" name="aplazachequeForm" enctype="multipart/form-data" method="post" novalidate>
      <input type="hidden" id="modulo" name="modulo" value="dival">
      <input type="hidden" id="option" name="option" value="cheques">
      <input type="hidden" id="action" name="action" value="aplaza">
            ...
            <div class="card mb-2">
               ...
               <div class="card-body">
                  <div class="row g-lg-3">
                     ...
                     <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="form-group">
                           <label for="vencimiento" class="text-label fs-0 ps-0">Vencimiento *</label>
...
<script src="app/js/dival/aplazarcheque.js?v=1.0.0"></script>