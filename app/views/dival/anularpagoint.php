<div class="content p-2 pt-10">
	<div class="row mb-3">
   	<div class="col-lg-8">
      	<h4 class="mb-0">Anular Pago de Intereses</h4>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-2 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Anular Pago Intereses</li>
      		</ol>
      	</nav>
   	</div>
	</div>
	<form class="needs-validation form-search formPagoIntAnu" role="form" id="formPagoCapAnu" name="formPagoCapAnu" enctype="multipart/form-data" method="post" novalidate>
...
<script src="app/js/dival/anularpagoint.js?v=1.0.0"></script>