...
<div class="content p-2 pt-10">
	<div class="row mb-4">
   	<div class="col-lg-8">
      	<h3 class="mb-0">Cambiar Cheque de Cliente</h3>
   	</div>
   	<div class="col-lg-4">
	...
	<form class="needs-validation form-search crearchequeForm" role="form" id="crearchequeForm" name="crearchequeForm" enctype="multipart/form-data" method="post" novalidate>
      ...
      <input type="hidden" id="fechaActual" name="fechaActual" vslue="<?php echo date('Y-m-d'); ?>">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12">
                        <div class="table-responsive scrollbar" style="min-height:100px; max-height: 490px; overflow-y: auto;">
                           ...
                           <table class="table table-sm table-hover mb-0 border-top border-200" id="saldoCarteraTable" style="position: relative; border-collapse: collapse; width: 99%; font-size: 11px;">
                              <thead>
                                 <tr>
               ...
               <div class="card-body">
                  ...
                  <div class="row g-lg-3">
                     ...
                     <div class="col-lg-4">
                        ...
                        <div class="col-12 mb-3">
                           <div class="form-group" style="text-align: right;" >
                              <label for="impuesto_banco" class="text-label fs-0 ps-1">% Impot Bco</label>
...
<script src="app/js/dival/crearcheque.js"></script>