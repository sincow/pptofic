         		...
         		<div class="d-flex flex-wrap gap-3">
         			<div class="search-box">
						...
						<?php
							$permiAdd = "";
							$permiExp = "";
							$opcion = array_search("bancoadd", array_column($_SESSION['permissionsvet'], 'OpcLink'));
							...
							$opcion = array_search("bancosexport", array_column($_SESSION['permissionsvet'], 'OpcLink'));
							if ($opcion !== NULL && $opcion !== FALSE) {
								$permi = $_SESSION['permissionsvet'][$opcion]["UsuPermi"];
								if ($permi != 0) {
                     ...
                     $permiMod = "";
                     $permiDel = "";
                     $opcion = array_search("bancoedit", array_column($_SESSION['permissionsvet'], 'OpcLink'));
                     if ($opcion !== NULL && $opcion !== FALSE) {
                        $permi = $_SESSION['permissionsvet'][$opcion]["UsuPermi"];
                        if ($permi != 0) {
                           $permiModsw = "1";
                     ...
                     $opcion = array_search("bancodelete", array_column($_SESSION['permissionsvet'], 'OpcLink'));
                     if ($opcion !== NULL && $opcion !== FALSE) {
                        $permi = $_SESSION['permissionsvet'][$opcion]["UsuPermi"];
                        if ($permi != 0) {
                           $permiDelsw = "1";
