...
<div class="content p-2 pt-10">
	<div class="row mb-4">
   	<div class="col-lg-8">
      	<h4 class="mb-0">Pago de Capital</h4>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-2 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Pago Capital</li>
      		</ol>
      	</nav>
   	</div>
	</div>
	<form class="needs-validation form-search pagocapitalForm" role="form" id="pagocapitalForm" name="pagocapitalForm" enctype="multipart/form-data" method="post" novalidate>
      <input type="hidden" id="modulo" name="modulo" value="dival">
      <input type="hidden" id="option" name="option" value="cheques">
      <input type="hidden" id="action" name="action" value="pagocapital">
               ...
               <div class="card-body">
                  <div class="row g-lg-3">
                     ...
                     <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="form-group text-end">
                           <label for="capital_pagar" class="text-label fs-0 ps-0">Capital a Pagar *</label>
                           ...
                           <input type="text" class="form-control p-2" style="text-align: right;" id="capital_pagar" name="capital_pagar" valMax=0 maxlength="11" value="0" >
                        </div>
                     </div>
                  ...
                  <div class="row g-lg-4 mb-3">
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3 border">
                        ...
                        <div class="col-12 mb-3">
                           <div class="form-group" style="text-align: right;" >
                              <label for="valCheque" class="text-label fs-0 ps-0">Vlr Cheque</label>
            ...
            <div class="card mb-0">
               <div class="card-body p-3">
                  <div class="d-grid gap-2">
                     <button class="btn btn-phoenix-success" type="submit" id="btnDevolAdd">GRABAR PAGO CAPITAL</button>
                  </div>
               </div>
            </div>
         </div>
...
<script src="app/js/dival/pagocapital.js?v=1.0.0"></script>