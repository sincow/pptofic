<div class="content p-2 pt-10">
	<div class="row mb-2">
   	<div class="col-lg-8">
      	<h3 class="mb-0">Cuentas Bancarias de Clientes</h3>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-0 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Cuentas Clientes</li>
      		</ol>
      	</nav>
   	</div>
	</div>
         		...
         		<div class="d-flex flex-wrap gap-3">
         			<div class="search-box">
							<form class="position-relative" data-bs-toggle="search" data-bs-display="static">
								<input class="form-control search-input search" id="searchCtaClien" name="searchCtaClien" type="search" placeholder="Buscar Cuentas" aria-label="Search" />
				...
				<div class="mx-n4 px-4 mx-lg-0 px-lg-2 bg-white border-top border-bottom border-200 position-relative top-1">
					<div class="table-responsive scrollbar mx-n1 px-1">
						<form role="form" class="mb-1 especieFormEdit" method="post" action="especiemodify">
							<table class="table table-striped mb-0 ctaclienTable" style="font-size: 12px;" id="ctaclienTable">
								...
								<tbody class="list" id="ctaclien-table-body">
                           <tr>
	...
	<?php
		include "ctaclienedit.php";
		include "ctaclienadd.php";
		include APP_PATH.'/views/layouts/footer.php';
	?>
</div>
<script src="app/js/dival/ctaclien.js"></script>