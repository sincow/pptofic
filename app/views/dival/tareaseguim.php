<div class="content p-2 pt-10">
	<div class="row mb-4">
   	<div class="col-lg-8">
      	<h4 class="mb-0">Seguimiento a Tarea</h4>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-2 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Seguimiento Tarea</li>
      		</ol>
      	</nav>
   	</div>
	</div>
            ...
            <div class="card mb-2">
               <div class="card-body">
                  ...
                  <div class="row g-3">
                     <div class="col-sm-6 col-lg-4 mb-3">
                        <div class="form-group">
                           <label for="fecha" class="text-label fs-0 ps-0">Fecha Seguimiento *</label>
