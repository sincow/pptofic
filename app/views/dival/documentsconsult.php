...
<div class="content ps-2 pe-2 pt-10">
	...
	<form role="form" class="chequesForm" id="chequesForm" method="post" action="purchasedetail">
      ...
      <!-- <input type="hidden" name="pyt" value="<?php //getCSRFToken() ?>"> -->
		<div class="mb-3">
			<div id="chequesTable" data-list='{"valueNames":["po","customer","vendor","wh","created","expected","tracking","received","cost","status"],"page":20,"pagination":true}'>
				<div class="mb-1">
						...
						<form role="form" class="mb-1 poFormEdit" method="post" action="recsessionadd">
							...
							<table class="table table-striped table-sm fs--1 mb-0 documentsTable" id="documentsTable">
								<thead style="background-color: var(--phoenix-body-bg); backdrop-filter: blur(8px); opacity: 0.98;">
									<tr>
										<th class="sort align-middle white-space-nowrap pe-3" scope="col" data-sort="po" style="width:7%;">Compte #</th>
										<th class="sort align-middle text-start ps-0" scope="col" data-sort="customer" style="width:6%;">Nro Cheque</th>
										<th class="sort align-middle text-start ps-0" scope="col" data-sort="vendor"   style="width:18%; min-width: 100px;">Cliente</th>
										<th class="sort align-middle text-start ps-0" scope="col" data-sort="wh"       style="width:6%;">Fec.Cheque</th>
										<th class="sort align-middle text-start ps-0" scope="col" data-sort="created"  style="width:7%;">Fec.Vencim</th>
										<th class="sort align-middle text-end ps-2" scope="col" data-sort="expected"   style="width:8%;">Vlr Cheque</th>
										<th class="sort align-middle text-end ps-1" scope="col" data-sort="status"   style="width:8%;">Sdo Capital</th>
										...
										<th class="sort align-middle text-end ps-2" scope="col" data-sort="received"   style="width:8%;">Int Cobrado</th>
										<th class="sort align-middle text-end pe-2"   scope="col" data-sort="cost"     style="width:8%;">Sdo Interes</th>
										<th class="sort align-middle text-start ps-0" scope="col" data-sort="wh"       style="width:7%;">Estado</th>
