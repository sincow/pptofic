<div class="content p-2 pt-10">
   <div class="row mb-3">
      <div class="col-lg-8">
         <h4 class="mb-0">Planilla de Arqueo</h4>
      </div>
      <div class="col-lg-4 pt-1">
         <nav class="mb-0" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 float-sm-end">
               ...
               <li class="breadcrumb-item active">>Planilla de Arqueo</li>
            </ol>
         </nav>
      </div>
   </div>
   <form class="needs-validation frmReports" role="form" id="frmReports" method="post" action="" novalidate>
      ...
      <input type="hidden" id="action" name="action" value="repplaarqueo">
      <div class="row g-3">
                        ...
                        <div class="row align-items-center g-5 text-center text-sm-start">
                           <div class="col-12 col-sm-auto flex-1 mt-0 mb-2">
                              <div class="row g-3 mt-3">
                                 <label class="text-label fs-0 ps-2" for="repFecPlanilla">Fecha</label>
                                 <div class="col-md-3 col-xl-1 mt-0 mb-0">
                                    <div class="form-control mb-0 p-0 border-0">
                                       <input type="text" class="form-control datepicker py-2 dp_fecha_ini" id="repFecPlanilla" name="repFecPlanilla" placeholder="<?php echo DATE_DISPLAY ?>" data-inputmask="'alias': '<?= DATE_DISPLAY ?>'" autocomplete="off" data-mask required>
                                    </div>
                                 </div>
                              </div>
                              <div class="row g-3 mt-3">
                                 <label class="text-label fs-0 ps-2 mt-0" for="repValContado">Efectivo Contado</label>
                                 <div class="col-md-3 col-xl-1 mt-0 mb-3">
                                    <div class="form-control mb-0 p-0 border-0">
                                       <input type="text" class="form-control py-2 text-end" id="repValContado" name="repValContado" autocomplete="off" value=0 equired>
                                    </div>
                                 </div>
                              </div>
