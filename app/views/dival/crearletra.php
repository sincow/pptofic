...
<div class="content p-2 pt-10">
	<div class="row mb-4">
   	<div class="col-lg-8">
      	<h4 class="mb-0">Creación de Letra</h4>
   	</div>
   	<div class="col-lg-4">
   		<nav class="mb-0" aria-label="breadcrumb">
      		<ol class="breadcrumb mb-2 float-sm-end">
         		<li class="breadcrumb-item"><a href="./">Dashboard</a></li>
         		<li class="breadcrumb-item active">Creación Letra</li>
      		</ol>
      	</nav>
   	</div>
	</div>
	<form class="needs-validation form-search crearchequeForm" role="form" id="crearchequeForm" name="crearchequeForm" enctype="multipart/form-data" method="post" novalidate>
      ...
      <div class="row g-3">
         ...
         <div class="col-lg-5 mt-0">
            <div class="card mb-3">
               <div class="card-header fw-bold py-1 fs-0 text-start text-white bg-primary" style="opacity: 70%;">
                  <i class="fa-solid fa-file-signature me-2"></i>Datos de la Letra
               </div>
               <div class="card-body">
                  <div class="row g-lg-3">
                     <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="form-group">
                           <label for="fechaActual" class="text-label fs-0 ps-1">Fecha Letra *</label>
                  ...
                  <div class="row g-lg-3">
                     ...
                     <div class="col-lg-4">
                        <div class="col-12 mb-3">
                           <div class="form-group" style="text-align: right;" >
                              <label for="valor_cheque" class="text-label fs-0 ps-1">Valor Letra *</label>
            ...
            <div class="card mb-0">
               <div class="card-body p-3">
                  <div class="d-grid gap-2">
                     <button class="btn btn-phoenix-success" type="submit" id="btnChequeAdd">GRABAR LETRA</button>
                  </div>
               </div>
            </div>
         </div>
