...
class TipoFinanciacionModel {
   ...
   static public function getAll($conn = null) {
      ...
      $stmt = $connection->prepare("SELECT TipoFinanciacionId, Nombre, Estado, UsuarioId, 
         FechaCreacion, FechaModificacion
         FROM poTipoFinanciacion
   ...
   static public function getWhere($data) {
      ...
      $connection = Database::getConnection();
      $stmt = $connection->prepare("SELECT a.TipoFinanciacionId, a.Nombre, a.Estado, a.UsuarioId, 
         a.FechaCreacion, a.FechaModificacion  
         FROM poTipoFinanciacion a 
         WHERE 1 = 1 " . $where . "
         ORDER BY a.nombre"
      );
      $stmt->bindParam(":id_empresa", $_SESSION["id_empresa"], PDO::PARAM_INT);
   ...
   static public function getOne($id) {
      ...
      $stmt = $connection->prepare("SELECT a.TipoFinanciacionId, a.Nombre, a.Estado, a.UsuarioId, 
         a.FechaCreacion, a.FechaModificacion
         FROM poTipoFinanciacion a 
         WHERE a.EmpresaId = :id_empresa AND a.TipoFinanciacionId = :id"
      );
      $stmt->bindParam(":id_empresa", $_SESSION["id_empresa"], PDO::PARAM_INT);
