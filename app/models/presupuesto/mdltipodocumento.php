...
class TipoDocumentoModel {
   ...
   static public function getAll($conn = null) {
      ...
      $stmt = $connection->prepare("SELECT TipoDocumentoId, Nombre, Iniciales, Estado, UsuarioId, 
         FechaCreacion, FechaModificacion
         FROM poTipoDocumento
   ...
   static public function getWhere($data) {
      ...
      $connection = Database::getConnection();
      $stmt = $connection->prepare("SELECT a.TipoDocumentoId, a.Nombre, a.Iniciales, a.Estado, a.UsuarioId, 
         a.FechaCreacion, a.FechaModificacion  
         FROM poTipoDocumento a 
         WHERE 1 = 1 " . $where . "
         ORDER BY a.nombre"
      ); 
      $stmt->bindParam(":id_empresa", $_SESSION["id_empresa"], PDO::PARAM_INT);
   ...
   static public function getOne($id) {
      ...
      $stmt = $connection->prepare("SELECT a.TipoDocumentoId, a.Nombre, a.Iniciales, a.Estado, a.UsuarioId, 
         a.FechaCreacion, a.FechaModificacion
         FROM poTipoDocumento a 
         WHERE a.EmpresaId = :id_empresa AND a.TipoDocumentoId = :id"
      );
      $stmt->bindParam(":id_empresa", $_SESSION["id_empresa"], PDO::PARAM_INT);
