...
class DependenciaModel {
   ...
   static public function getAll($conn = null) {
      ...
      $stmt = $connection->prepare("SELECT DependenciaId, Nombre, Estado, Iniciales, CentroCtoId, UsuarioId, 
   ...
   static public function getWhere($data) {
      ...
      $connection = Database::getConnection();
      $stmt = $connection->prepare("SELECT a.DependenciaId, a.Nombre, a.Estado, a.Iniciales, a.CentroCtoId,  a.UsuarioId, 
