...
class PHPExcel_Calculation_Functions {
	...
	public static function _ifCondition($condition) {
		...
		// if (!isset($condition{0}))  				// ALVARO CARMONA  2024-06-09
			$condition = '=""';
		if (!in_array($condition[0],array('>', '<', '='))) {
		// if (!in_array($condition{0},array('>', '<', '='))) {			// ALVARO CARMONA 2024-06-09
	...
	public static function N($value = NULL) {
		...
		switch (gettype($value)) {
			...
			case 'string'	:
				...
				// if ((strlen($value) > 0) && ($value{0} == '#')) {                // ALVARO CARMONA 2024-06-09
					return $value;
				}
				break;
		}
